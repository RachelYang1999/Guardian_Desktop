...
public class FindMarketPlaceSuccessBox1 extends AlertBox {

    @Override
    public void createAlertBox(Entity entity) {
        String loanInfo = entity.getEntityInformation();
        System.out.println("Find market place successfully");
        window.setTitle("Find Market Place Successfully");
        ...
        Button copyButton = new Button("Copy Market Information");
