...
public class AvailableLoanBox extends AlertBox {
    ...
    public void createAlertBox(List<Entity> entity) {
        ...
        for (Entity e : entity) {
            loanInfo += e.getEntityInformation();
        }
        window.setTitle("Available Loan Information");
        ...
        Button copyButton = new Button("Copy Loan Information");
