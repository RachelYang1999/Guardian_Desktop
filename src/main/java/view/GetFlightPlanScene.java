...
public class GetFlightPlanScene {
    ...
    public GetFlightPlanScene(Stage window, GameEngine gameEngine) throws Exception {
        this.window = window;
        ...
        Text t = new Text();
        t.setCache(true);
        t.setText("Get Available Flight Plans Here!");
        ...
        Label shipLocationLabel = new Label("System Symbol");
        TextField shipLocationTextField = new TextField("OE");
...
//        userNameHBox.setAlignment(Pos.CENTER);
        ...
        buyButton.setOnAction(event -> {
            ...
            Entity returnedEntity = gameEngine.getAvailableFlightPlans(
            ...
            if (returnedEntity == null) {
                System.err.println("[BuyOther] Buy A Loan Fail\n No returnedEntity");
            } else {
        ...
        labelBox.getChildren().addAll(shipLocationLabel);
        labelBox.setAlignment(Pos.CENTER_RIGHT);

        VBox textFieldBox = new VBox(15);
        textFieldBox.getChildren().addAll(shipLocationTextField);
