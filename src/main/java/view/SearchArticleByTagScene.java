...
//
//public class SearchArticleByTagScene {
...
//
//  public SearchArticleByTagScene(Stage window, RequestMapping requestMapping) throws Exception {
//    this.window = window;
...
//            } else {
//
//              window.setScene(new TagsResultScene(window, requestMapping, inputTag).getScene());
