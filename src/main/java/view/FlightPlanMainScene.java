...
public class FlightPlanMainScene {
    ...
    public FlightPlanMainScene(Stage window, GameEngine gameEngine) throws Exception {
        this.window = window;
        ...
        button12.setOnAction(event -> {
            try {
                window.setScene(new GetFlightPlanScene(window, gameEngine).getScene());
                window.setTitle("Get Available Flight Plans");
            } catch (Exception e) {
                e.printStackTrace();
            }
        });
        ...
        button13.setText("Create\nFlight\nPlan");
        button13.setTextAlignment(CENTER);
        button13.setOnAction(event -> {
            try {
                window.setScene(new CreateFlightPlanScene(window, gameEngine).getScene());
            } catch (Exception e) {
                e.printStackTrace();
            }
        });
