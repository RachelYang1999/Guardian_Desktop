...
public class BuyOtherScene {
    ...
    public BuyOtherScene(Stage window, GameEngine gameEngine) throws Exception {
        this.window = window;
        ...
        Text t = new Text();
        t.setCache(true);
        t.setText("Buy Other Goods Here!");
...
//        userNameHBox.setAlignment(Pos.CENTER);
        ...
        Label goodNameLabel = new Label("Good Name");
        TextField goodNameTextField = new TextField("METALS");
...
//        tokenHBox.setAlignment(Pos.CENTER);
        ...
        buyButton.setOnAction(event -> {
            ...
            Entity returnedEntity = gameEngine.buyGood(
        ...
        labelBox.getChildren().addAll(shipIDLabel, goodNameLabel, quantityLabel);
        labelBox.setAlignment(Pos.CENTER_RIGHT);

        VBox textFieldBox = new VBox(15);
        textFieldBox.getChildren().addAll(shipIDTextField, goodNameTextField, quantityTextField);
